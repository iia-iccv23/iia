import numpy as np
import torch
from torchgc.pytorch_grad_cam.base_cam import BaseCAM
from torchgc.pytorch_grad_cam.utils.find_layers import find_layer_predicate_recursive
from torchgc.pytorch_grad_cam.utils.svd_on_activations import get_2d_projection
from torchgc.pytorch_grad_cam.utils.image import scale_accross_batch_and_channels, scale_cam_image
